...
//escrever conteudo no ficheiro
	...
	$conteudo.="{$_SESSION['provisoes']},{$_SESSION['note']},{$_SESSION['ouro']},{$_SESSION['armour']},";
	...
	$conteudo.="{$_SESSION['nbattle']},{$_SESSION['nbattle2']},{$_SESSION['nbattle3']},{$_SESSION['forcainicial']},{$_SESSION['pag']},";
