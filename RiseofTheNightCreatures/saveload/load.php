...
//listar conteudo
list($nome,$forca,$pericia,$sorte,$lproesa,$provisoes,$ouro,$note,$curse,$code,$i1,$i2,$i3,$i4,$i5,$i6,$i7,$i8,$i9,$i10,$i11,$i12,$i13,$i14,$i15,$i16,$i17,$i18,$i19,$i20,$i21,$i22,$i23,$i24,$weapon,$piano,$gas,$pi,$si,$fi,$pag)=explode(",",$conteudo);
//escrever conteudo nas sessoes
$_SESSION["nome"]=$nome;$_SESSION["forca"]=$forca;$_SESSION["pericia"]=$pericia;$_SESSION["sorte"]=$sorte;$_SESSION["lproesa"]=$lproesa;
$_SESSION["provisoes"]=$provisoes;$_SESSION['note']=$note;$_SESSION['curse']=$curse;$_SESSION['code']=$code;$_SESSION["ouro"]=$ouro;
...
$_SESSION["item21"]=$i21;$_SESSION["item22"]=$i22;$_SESSION["item23"]=$i23;$_SESSION["item24"]=$i24;
$_SESSION["weapon"]=$weapon;$_SESSION["piano"]=$piano;$_SESSION["gas"]=$gas;
...
$_SESSION["stime"]=time();
$_SESSION["gamebook"]="Rise of the Night Creatures (previously saved)";
?>
