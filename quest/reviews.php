...
<title>Fighting Fantasy Amateur Adventure - Quest for the Ebony Wand Reviews</title>
...
<div class="row">
  ...
  <p>Gamebooks reviews page</p>
    ...
    <h3>Quest for the Ebony Wand&copy</h3><h3> by Keetatag  </h3>
    </div>
    <?php
    ...
    <script type="text/javascript">
        ...
        var disqus_identifier = 'questftew';
