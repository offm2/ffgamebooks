...

{
...

    {
        ...
        $this->open('ffgamebooks_thebeast-bd.db3',SQLITE3_OPEN_READONLY);
...
$stm =$db->prepare("SELECT * FROM thebeast WHERE incremento=:pag");
...
echo "<div id='sayt'><p>{$ver['textos']}</p></div>";
