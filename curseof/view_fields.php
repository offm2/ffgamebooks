...

{
...

    {
        ...
        $this->open('ffgamebooks_curseof-bd.db3',SQLITE3_OPEN_READONLY);
...
$stm =$db->prepare("SELECT * FROM curseof WHERE incremento=:pag");
...
//se tocou na cabeca morta

if($_SESSION["tdhead"]=="yes"){$_SESSION["forca"]-=1;echo"<h5>You are infected and lose 1 stamina point</h5>";}
