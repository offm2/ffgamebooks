...
$messages_buffer_file = 'json_chat_file.txt';
...
<head>
	...
	<title>Fighting Fantasy Fan site Chat</title>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var poll_for_new_messages = function(){
				$.ajax({url: 'json_chat_file.txt', dataType: 'json', ifModified: true, timeout: 2000, success: function(messages, status){
	...
	<h3>Welcome to the Fansite chat</h3>
	<ul id="messages">
	<li>loading…</li>
</ul>

<form id="formc" action="<?= htmlentities($_SERVER['PHP_SELF'], ENT_COMPAT, 'UTF-8'); ?>" method="post">
	<p>
		<input type="text" name="content" id="content" placeholder="Input messages" />
	</p>
	<p>
		<label>
			Name:
