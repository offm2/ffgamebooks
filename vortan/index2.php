...
$_SESSION["provisoes"]=5;
if(ctype_alnum($pocao))
{$_SESSION["pocao"]=$pocao;}
...
$_SESSION["extral"]=0;$_SESSION["weapon"]="no1";
...
iniciar($_POST['nome'],$_POST['potion']);
}
?>
...
<title>Fighting Fantasy Amateur Adventure - Venom of Vortan</title>
...
<div class="row">
  ...
  <p>Gamebooks playing area</p>
    ...
    <h3>Venom of Vortan&copy</h3><h3> by Mark Lain  </h3>
    </div>
    <?php
...
echo "<img style='float:right' src='imagens/snake.jpg' width=100 height=100>";
...
echo "<hr></hr>";
  ...
  echo "<p>Potion:<span contentEditable='true' id='potion'>{$_SESSION['pocao']}</span> | ";
