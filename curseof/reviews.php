...
<div>
<center>
<h3>The Curse of Blackwood Manor&copy</h3><h3> By Craig Dutton </h3>
</center> 
</div>
...
//resto do conteudo
echo "<h4>To hear the text please install the <a target='_blank' href='https://chrome.google.com/webstore/detail/speakit/pgeolalilifpodheeocdmbhehgnkkbak'>Speakit!</a> addon for Google Chrome</h4>";
...
echo"<input type='text' size=8 name='word1' value={$_SESSION['word1']}><input type='text' size=8 name='word2' value={$_SESSION['word2']}><input type='text' size=8 name='word3' value={$_SESSION['word3']}><input type='text' size=8 name='word4' value={$_SESSION['word4']}></p>";
echo "</form>";
echo "</div>";
?>
<center>
