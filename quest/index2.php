...
$_SESSION["provisoes"]=5;$_SESSION["note"]="";$_SESSION["ouro"]=0;$_SESSION["armour"]="";
$_SESSION["item1"]="";$_SESSION["item2"]="";$_SESSION["item3"]="";$_SESSION["item4"]="";$_SESSION["item5"]="";
$_SESSION["item6"]="";$_SESSION["item7"]="";$_SESSION["item8"]="";$_SESSION["item9"]="";$_SESSION["item10"]="";
$_SESSION["item11"]="";$_SESSION["item12"]="";$_SESSION["item13"]="";$_SESSION["item14"]="";
$_SESSION["item15"]="";$_SESSION["item16"]="";$_SESSION["item17"]="";$_SESSION["item18"]="";
$_SESSION["item19"]="";$_SESSION["item20"]="";
$_SESSION["nbattle"]=0;$_SESSION["nbattle2"]=0;$_SESSION["nbattle3"]=0;
...
<title>Fighting Fantasy Amateur Adventure - Quest for the ebony Wand</title>
...
<div class="row">
  ...
  <p>Gamebooks playing area</p>
    ...
    <h3>Quest for the ebony Wand&copy</h3><h3> by Kekataag  </h3>
    </div>
    <?php
    ...
    echo "Armour:<span contentEditable='true' id='armour'>{$_SESSION['armour']}</span></p>";
    ...
    //add note
    if($_SESSION["note"]!=""){echo "<p class='inv'>{$_SESSION["note"]}</p>"; }

if (!isset($_GET['pag'])){
    echo "<p><b>BACKGROUND</b></p><p>";
    echo "<img style='float:right' src='imagens/vila.gif' width=100 height=100>";
