...
//listar conteudo
list($nome,$forca,$pericia,$sorte,$provisoes,$note,$ouro,$armour,$i1,$i2,$i3,$i4,$i5,$i6,$i7,$i8,$i9,$i10,$i11,$i12,$i13,$i14,$i15,$i16,$i17,$i18,$i19,$i20,$nb,$nb2,$nb3,$fi,$pag)=explode(",",$conteudo);
//escrever conteudo nas sessoes
$_SESSION["nome"]=$nome;$_SESSION["forca"]=$forca;$_SESSION["pericia"]=$pericia;$_SESSION["sorte"]=$sorte;
$_SESSION["provisoes"]=$provisoes;$_SESSION["note"]=$note;$_SESSION["ouro"]=$ouro;$_SESSION["armour"]=$armour;
...
$_SESSION["nbattle"]=$nb;$_SESSION["nbattle2"]=$nb2;$_SESSION["nbattle3"]=$nb3;$_SESSION["forcainicial"]=$fi;
...
echo "<br><h4>Insert password above to load the data in the pages</h4>";
//para a pagina de highscores
$_SESSION["stime"]=time();
$_SESSION["gamebook"]="Quest for the ebony Wand (previously saved)";
?>
