...
$_SESSION["ouro"]+=3;echo"<script type='text/javascript'>ouro=Number(document.getElementById('ouro').innerHTML);document.getElementById('ouro').innerHTML=ouro + 3;</script>";$_SESSION["potion"]=1;
$_SESSION["provisoes"]+=1;echo"<script type='text/javascript'>prov=Number(document.getElementById('provisoes').innerHTML);document.getElementById('provisoes').innerHTML=prov+1;</script>";
}
elseif($_GET["pag"]=="28")
...
elseif($_GET["pag"]=="33")
{$_SESSION["item7"]="cutlass";echo"<script type='text/javascript'>document.getElementById('item7').innerHTML='cutlass';</script>";
...
if(isset($_GET["meal"])&&$_GET["meal"]=="yes"){$_SESSION["forca"]+=2;echo"<script type='text/javascript'>forca=Number(document.getElementById('forca').innerHTML);document.getElementById('forca').innerHTML=forca - 2;</script>";
...
}else{$_SESSION["sorte"]-=1;echo"<script type='text/javascript'>sorte=Number(document.getElementById('sorte').innerHTML);document.getElementById('sorte').innerHTML=sorte - 1;</script>";echo"<h5>You lose 1 point of luck</h5>";}}
elseif($_GET["pag"]=="40")
{$_SESSION["forca"]-=1;echo"<script type='text/javascript'>forca=Number(document.getElementById('forca').innerHTML);document.getElementById('forca').innerHTML=forca - 1;</script>";
...
else{$_SESSION["forca"]-=1;echo"<script type='text/javascript'>forca=Number(document.getElementById('forca').innerHTML);document.getElementById('forca').innerHTML=forca - 1;</script>";
