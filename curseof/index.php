...
<META NAME="KEYWORDS" CONTENT="fighting fantasy gamebooks, fighting fantasy, gamebooks, online gamebooks, amateur gamebooks, Curse of Blackwood Manor">
...
<div class="row">
  <div class="col-sm-12">
    ...
    <label for="adv4name">Insert name:</label>
    <input type="text" class="form-control" name="nome" id="adv4name" placeholder="Name">
    </div>
    <?php
