...
{$_SESSION["item1"]="dagger";echo"<script type='text/javascript'>document.getElementById('item1').innerHTML='dagger';</script>";
...
if($_SESSION["weapon"]=="no1"||$_SESSION["weapon"]=="no2"){$_SESSION["pericia"]+=4;echo"<script type='text/javascript'>pericia=Number(document.getElementById('pericia').innerHTML);document.getElementById('pericia').innerHTML=pericia + 4;</script>";
echo "<h5>You now have a weapon and gained 4 points of stamina</h5>";$_SESSION["weapon"]="yes1";}
}
if(isset($_GET["salve"]))
{$_SESSION["item2"]="salve";echo"<script type='text/javascript'>document.getElementById('item2').innerHTML='salve';</script>";
...
{$_SESSION["item3"]="figurine";echo"<script type='text/javascript'>document.getElementById('item3').innerHTML='figurine';</script>";
...
{$_SESSION["item4"]="ropeandgrapple";echo"<script type='text/javascript'>document.getElementById('item4').innerHTML='ropeandgrapple';</script>";
...
elseif($_GET['pag']=="8")
{echo"<h5>You cast the Fear Spell</h5>";$_SESSION["forca"]-=1;echo"<script type='text/javascript'>forca=Number(document.getElementById('forca').innerHTML);document.getElementById('forca').innerHTML=forca - 1;</script>";}
elseif($_GET['pag']=="11")
{echo"<h5>You cast the Fear Spell</h5>";$_SESSION["forca"]-=1;echo"<script type='text/javascript'>forca=Number(document.getElementById('forca').innerHTML);document.getElementById('forca').innerHTML=forca - 1;</script>";}
elseif($_GET['pag']=="13")
{$_SESSION["ouro"]-=2;echo"<script type='text/javascript'>ouro=Number(document.getElementById('ouro').innerHTML);document.getElementById('ouro').innerHTML=ouro - 2;</script>";}
elseif($_GET['pag']=="14")
{$_SESSION["item6"]="silver_dagger";echo"<script type='text/javascript'>document.getElementById('item6').innerHTML='silver_dagger';</script>";if($_SESSION["weapon"]=="no1"||$_SESSION["weapon"]=="no2"){$_SESSION["pericia"]+=4;echo"<script type='text/javascript'>pericia=Number(document.getElementById('pericia').innerHTML);document.getElementById('pericia').innerHTML=pericia + 4;</script>";
echo "<h5>You now have a weapon and gained 4 points of stamina</h5>";$_SESSION["weapon"]="yes1";}
if($_SESSION["pericia"]<12){echo"<script type='text/javascript'>pericia=Number(document.getElementById('pericia').innerHTML);document.getElementById('pericia').innerHTML=pericia + 1;</script>";$_SESSION["pericia"]+=1;}
...
echo"<script type='text/javascript'>document.getElementById('item6').innerHTML='silver_dagger';</script>";}}
elseif($_GET['pag']=="18")
...
elseif($_GET['pag']=="19")
{echo"<h5>You lose 1 point of luck</h5>";$_SESSION["sorte"]-=1;echo"<script type='text/javascript'>sorte=Number(document.getElementById('sorte').innerHTML);document.getElementById('sorte').innerHTML=sorte - 1;</script>";}
elseif($_GET['pag']=="20")
...
$_SESSION["ouro"]+=5;echo"<script type='text/javascript'>ouro=Number(document.getElementById('ouro').innerHTML);document.getElementById('ouro').innerHTML=ouro + 5;</script>";}
elseif($_GET['pag']=="24")
{$_SESSION["forca"]-=1;echo"<script type='text/javascript'>forca=Number(document.getElementById('forca').innerHTML);document.getElementById('forca').innerHTML=forca - 1;</script>";echo"<h5>You cast the open spell</h5>";}
elseif($_GET['pag']=="25")
{if(in_array("illusion",$_SESSION["magic"])){echo"<h5>You can use the illusion spell, turn to 40</h5>";}}
elseif($_GET['pag']=="26")
{$_SESSION["ouro"]-=1;echo"<script type='text/javascript'>ouro=Number(document.getElementById('ouro').innerHTML);document.getElementById('ouro').innerHTML=ouro - 1;</script>";echo"<h5>You pay a gold piece</h5>";
