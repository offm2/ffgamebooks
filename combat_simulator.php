...
<META NAME="KEYWORDS" CONTENT="fighting fantasy gamebooks, fighting fantasy, gamebooks,dice,ff combat simulator "> 
...
<div class="row">
  <div class="col-sm-12">
  <!--news-->
  <h3 style="text-align:center">Fighting Fantasy combat simulator</h3>
    <div style="text-align:center">
    <?php include_once("combat_all.php");?>
    <h4><a href='ff_fighting_simulator/index.php' target='_blank'>Turn based fighting with dice rolls for luck</a></h4>
    </div>
  </div>
  <div class="col-sm-12">
  <div style="text-align:center">
