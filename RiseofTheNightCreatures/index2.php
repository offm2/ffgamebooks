...
$_SESSION["lproesa"]=mt_rand(1,6) + 6;
$_SESSION["provisoes"]=4;$_SESSION["ouro"]=0;
...
$_SESSION["weapon"]="no1";$_SESSION["note"]="";$_SESSION["curse"]="";$_SESSION["code"]="";$_SESSION["piano"]="";$_SESSION["gas"]="yes";
...
if (!isset($_GET['pag'])){
echo"<h3><a href='index2.php?pag=201'>PROLOGUE</a></h3>";
echo "<p><b>BACKGROUND</b></p><p>";
echo "<img style='float:right' src='imagens/Werewolf.jpg' widht=100 height=100>";
...
echo "<hr></hr>";
  ...
  echo "<p>W.Prowess:<span contentEditable='true' id='proesa'>{$_SESSION['lproesa']}</span> | ";
  ...
  echo "Provisions:<span contentEditable='true' id='provisoes'>{$_SESSION['provisoes']}</span> | ";
    ...
    if ($_SESSION["item21"]!=""||$_SESSION["item22"]!=""||$_SESSION["item23"]!=""||$_SESSION["item24"]!=""){echo "</p>";}
