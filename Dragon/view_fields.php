...

{
...

    {
        ...
        $this->open('ffgamebooks_sdragon_-bd.db3',SQLITE3_OPEN_READONLY);
...
$stm =$db->prepare("SELECT * FROM sdragon WHERE incremento=:pag");
...
if ($_GET["istamina"]<=0){echo"<h3>You Win!</h3>";if($_GET['pag']=='22'){echo"<h5>You got the Ebony key</h5>";$_SESSION["item6"]=="Ebony_key#11";}}
