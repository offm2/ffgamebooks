...
<META NAME="KEYWORDS" CONTENT="fighting fantasy gamebooks, fighting fantasy, gamebooks, online gamebooks, amateur gamebooks, Venom of Vortam"> 
...
<div class="row">
  <div class="col-sm-12">
    ...
    <form name="f2" method="POST" action="index2.php">
    <p><img width='55' height='80' src="../img/character_m.png"><img width='55' height='80' src="../img/character_f.png"></p>
    <div class="form-group">
    <label for="adv2name">Insert name:</label>
    <input type="text" class="form-control" name="nome" id="adv2name" placeholder="Name">
    </div>
<div class="col-sm-12">
<?php 
    ...
    echo"<p><label for='potion'>Potion : </label><select class='form-control' name='potion'><option value='stamina'>Stamina</option><option value='skill'>Skill</option><option value='luck'>Luck</option></select></p>"; 
    echo"</div>";
    ?>
