...
<div style="float:left"><img width="110" height="220" src="images/character_m.png"></div>
<div style="float:left"><center><p><button  type="button" onclick="javascript:location.reload(true);"><b>Make new character</b></button></p></br>
<p><label class="control-label">Character name:</label> <input type="text" size=15 name='nome' maxlength="15"></p></br>
<?php 
...
<div style="float:left"><img width="110" height="220" src="images/character_f.png"></div>
</form>
</div>
